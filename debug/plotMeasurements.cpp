...
BOOST_AUTO_TEST_CASE(Material) {
  ...
  //  std::cout << "before sourceLinks: " <<
  //  measurements.sourceLinks[3].get<TestSourceLink>().parameters[0] <<
  //  std::endl; measurements.sourceLinks[3].get<TestSourceLink>().parameters[0]
  //  += 100; std::cout << "after sourceLinks: " <<
  //  measurements.sourceLinks[3].get<TestSourceLink>().parameters[0] <<
  //  std::endl; std::cout << "before sourceLinks: " <<
  //  measurements.sourceLinks[3] << std::endl; auto& sl =
  //  measurements.sourceLinks[4]; std::cout << "before sourceLinks: " << sl <<
  //  std::endl; std::cout << "before sourceLinks: " << sl.parameters[0] <<
  //  std::endl;
  ...
  //  std::cout << "after sourceLinks: " << sl.parameters[0] << std::endl;
  ...
  //  std::cout << "sourceLinks: " << sourceLinks[0].get<TestSourceLink>() <<
  //  std::endl; std::cout << "before sourceLinks: " <<
  //  sourceLinks[3].get<TestSourceLink>().parameters[0] << std::endl;
  //  sourceLinks[3].get<TestSourceLink>().parameters[0] += 100;
  //  std::cout << "after sourceLinks: " <<
  //  sourceLinks[3].get<TestSourceLink>().parameters[0] << std::endl;
